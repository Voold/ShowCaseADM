...
import { getPaginationRange, type PaginationRange } from '@/utils/getPaginationRange'
...
function Pagination({ totalPages = 1, currentPage = 1, onPageSelect = () => {} }: PaginationProps) {
